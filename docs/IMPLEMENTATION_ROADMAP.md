...
## Phase 4 — academic gap expansion
Bridge existing digest output and add Crossref/TOC monitoring for gap journals. Apply synonym bundles and aging filters.
...
For each evidence cluster: explain what is new, preserve methods/caveats, find localizable dimensions, propose B2B/B2C angles, recommend visuals, list reporting needed, compare with media coverage and score targets.

## Phase 7 — dashboard
Views: today's evidence, emerging themes, data releases, localizable opportunities, B2B, B2C, undercovered topics, source health, coverage map and story backlog.
